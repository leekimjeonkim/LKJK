URL = "52.231.38.193" #Azure vm 주소.

#integer 값 범위 : 1~155, 최대 155개 샘플까지 수용가능
TARGET_COLUMN = 32
...
from pandas import read_table #download 용도, 추후 blob 이용 시 import 다르게 해야함.
import numpy as np
...
def plot(results):
    ...
    for subplot, (title, y, y_pred) in zip(plts, results):
        ...
        subplot.set_ylabel('pattern to song')
